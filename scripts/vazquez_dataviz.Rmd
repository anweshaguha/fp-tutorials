...
#RG: could you explain what the purpose of simulating data and provide some examples of instances that it could be applied?

#RG I don't think parallel looping is necessary here.

#RG perhaps provide examples of how the error messages work?
...
#RG What about using rnorm to simulate? i.e. rnorm(n = 4, c(.20,.30,.25,.25), levels, labels )
...
#RG I really like the colros and I think it is visually appealing
```
